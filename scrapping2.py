...
browser = webdriver.Chrome("/Users/Navneet/Downloads/chromedriver")
    ...
    for i in range(1, 430):
        while True:
            ...
            if current_page_num < i:
                ...
                browser.find_element_by_xpath('/html/body/div[2]/div/div[3]/section[2]/div/section[2]/div/div/article/div/div[2]/footer/div/div/div/nav/span[1]/a').click()
            else:
                break
